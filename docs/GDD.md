...
- **Board:** 20×10 grid (8-wide in Chill), triangle-half occupancy (`CellOccupancy` tracks full/bottom-left/top-right independently), 7-bag randomizer with a seedable RNG (deterministic — powers replays and Daily Challenge, see §6.4 and §6.6).
